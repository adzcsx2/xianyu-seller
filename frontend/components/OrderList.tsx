        ...
        <div className="toolbar rounded-none border-0 border-b shadow-none">
          ...
          <div className="flex w-full flex-col gap-2 md:w-auto md:flex-row md:items-center">
            <div className="group relative w-full md:w-auto">
               <Search className="w-4 h-4 absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[var(--brand-active)] transition-colors" />
               <input
                   type="text"
            ...
            <div className="modal-body space-y-4">
                  ...
                  {([[1, '好评'], [0, '中评'], [-1, '差评']] as Array<[1 | 0 | -1, string]>).map(([value, label]) => (
                    <button
                      ...
                      className={`rounded-md border px-3 py-2 text-sm font-bold transition-colors ${
                        rateValue === value
                          ? 'border-[var(--brand-active)] bg-[var(--brand)] text-[var(--brand-ink)]'
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-md border border-gray-200 px-3 py-2 text-sm focus:border-[var(--brand-active)] focus:outline-none"
                />
